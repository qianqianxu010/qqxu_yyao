...
delta_top10(:,4)=commom_score+t_bias(detected(4,1),:)';
delta_top10(:,5)=commom_score+t_bias(detected(5,1),:)';
delta_top10(:,6)=commom_score+t_bias(detected(6,1),:)';
delta_top10(:,7)=commom_score+t_bias(detected(7,1),:)';
delta_top10(:,8)=commom_score+t_bias(detected(8,1),:)';
delta_top10(:,9)=commom_score+t_bias(detected(9,1),:)';
